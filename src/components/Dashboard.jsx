        ...
        <div style={{ width: '100%', maxWidth: '1400px', margin: '0 auto' }} className="animate-fadeIn">
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="items-center gap-3 px-4 py-2 rounded-2xl hidden md:flex" >
                    ...
                    <button
                        onClick={refreshData}
                        disabled={isSyncing}
                        className="p-3 rounded-2xl text-white hover:text-primary transition-all active:scale-95 disabled:opacity-50"
            ...
            <div className="glass-panel" style={{ borderRadius: '24px', border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
                <div style={{ padding: '1.75rem', borderBottom: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest bg-white/5 py-1 px-3 rounded-full">Últimos 5 Itens</span>
                </div>
                <div style={{ padding: '0 1.75rem 1.75rem 1.75rem' }}>
                    <div className="overflow-x-auto">
                        <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 12px', textAlign: 'left' }}>
                            <thead>
                                <tr>
                                    <th style={{ padding: '0 1rem', color: 'rgba(255,255,255,0.4)', fontWeight: '600', fontSize: '0.75rem', textTransform: 'uppercase' }}>PROJETO</th>
                                    <th style={{ padding: '0 1rem', color: 'rgba(255,255,255,0.4)', fontWeight: '600', fontSize: '0.75rem', textTransform: 'uppercase' }}>STATUS</th>
                                    <th style={{ padding: '0 1rem', color: 'rgba(255,255,255,0.4)', fontWeight: '600', fontSize: '0.75rem', textTransform: 'uppercase' }}>DURAÇÃO</th>
                                    <th style={{ padding: '0 1rem', color: 'rgba(255,255,255,0.4)', fontWeight: '600', fontSize: '0.75rem', textTransform: 'uppercase' }}>DATA/HORA</th>
                                </tr>
                            </thead>
                            <tbody>
                                {orders.length === 0 ? (
                                    ...
                                    orders.map((row) => (
                                        <tr key={row.id} style={{
                                            ...
                                            <td style={{ padding: '1.25rem 1rem' }}>
                                                <span style={{
                                                    padding: '6px 12px', borderRadius: '10px', fontSize: '0.75rem', fontWeight: '800', display: 'inline-flex', alignItems: 'center', gap: '6px',
                                            ...
                                            <td style={{ padding: '1.25rem 1rem', color: 'rgba(255,255,255,0.6)', fontWeight: '600' }}>{row.time}</td>
                                            <td style={{ padding: '1.25rem 1rem', borderRadius: '0 12px 12px 0', color: 'rgba(255,255,255,0.4)', fontSize: '0.85rem' }}>
                                                {row.date || 'Recente'}
                                            </td>
                                        </tr>
                                    ))
